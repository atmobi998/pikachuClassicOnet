...
#define TIME_UPDATE_PROGRESS 0.019f
...
bool GameScene::init()
{
    ...
    gameboard->setGameboardTypeDrop(typeDropGameBoard);     /*gamepikachu board set type drop*/
    ...
    /*create AI check eat two gamepikachu*/
